...
EXACT_ROUTES = {
    ...
    "/api/auto-result": ("_dl_auto_result",    True),
    "/api/save-source": ("_dl_save_source",    True),
    "/api/save-search-to-library": ("_dl_save_search_to_library", True),
    ...
    "/api/countries":   ("send_countries",     False),
    "/api/test":        ("_test",              True),
...
DL_ENHANCER_MAP = {
    ...
    "_dl_auto_result":    "handle_auto_result",
    "_dl_save_source":    "handle_save_source",
    "_dl_save_search_to_library": "handle_save_search_to_library",
